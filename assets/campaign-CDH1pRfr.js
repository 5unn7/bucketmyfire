import{a as u,i as h,b as v,c as b,d as y,e as g,f as k,D as w,s as S,w as x,g as j,h as z,j as E,t as M,M as c,H as C,k as F}from"./frontShell-l_uKb0hn.js";import{i as H,p as t,w as p}from"./flyPicker-CdJt1YqK.js";u();h();v();b();y();g();H();T();function L(e){return e.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]??a)}let r=k(c).id;const i=document.getElementById("game");if(i){const e=document.createElement("div");e.className="bmf-app front",e.innerHTML=w+$(),i.innerHTML="",i.appendChild(e),document.getElementById("fd-boot")?.remove(),S(e,13),x(e),d(e)}function $(){return`
${j()}
${z("campaign")}
<div class="pad fhome">
