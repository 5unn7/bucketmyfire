import{a as h,i as u,b as v,c as b,d as y,e as g,f as k,D as w,s as S,w as x,g as j,h as z,j as E,t as M,M as c,H as C,k as F,l as H}from"./frontShell-BHqKT5Zn.js";import{i as L,p as t,w as p}from"./flyPicker-C9ewSIxg.js";h();u();v();b();y();g();L();T();let r=k(c).id;const i=document.getElementById("game");if(i){const e=document.createElement("div");e.className="bmf-app front",e.innerHTML=w+$(),i.innerHTML="",i.appendChild(e),document.getElementById("fd-boot")?.remove(),S(e,13),x(e),d(e)}function $(){return`
${j()}
${z("campaign")}
<div class="pad fhome">
