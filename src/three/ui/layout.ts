...
export interface LayoutSet {
  ...
  podSize: number; // instrument-spine pod row height (icon + micro-bar); bar/icon px derive from it
  headWidth: number; // heading tape width
  ...
  eyeSize: number; // free-look button size
