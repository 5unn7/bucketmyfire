...
export const UI = {
  ...
  bevelEdge: 'rgba(255,255,255,0.06)', // faint inner top rim on warm/secondary buttons (a hair of lift)
  warmGlassHi: 'rgba(60,24,18,0.6)', // secondary-button HOVER fill — warmer + denser than warmGlass
